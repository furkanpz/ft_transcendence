...
import { MULTI_HEIGHT, MULTI_WIDTH, MULTI_PLAYER_GAP, MULTI_PLAYER_HEIGHT, MULTI_PLAYER_WIDTH} from "../../backend/server/types/game.types";
...
export class MultiplayerGame {
    ...
    drawBackground() {
        ...
        const lineX = this.ball.pos.x * 0.1; 
    ...
    drawPlayers() {
        ...
        const p3Color = "#FFFF00";
        this.ctx!.fillStyle = p3Color;
        this.ctx!.shadowColor = p3Color;
        this.ctx!.shadowBlur = 25;

        this.ctx!.fillRect(this.players[2].pos.x - this.players[2].dim.x / 2, this.players[2].pos.y - this.players[2].dim.y / 2, this.players[2].dim.x, this.players[2].dim.y);

        const p4Color = "#FF00FF";
        this.ctx!.fillStyle = p4Color;
        this.ctx!.shadowColor = p4Color;
        this.ctx!.shadowBlur = 25;

        this.ctx!.fillRect(this.players[3].pos.x - this.players[3].dim.x / 2, this.players[3].pos.y - this.players[3].dim.y / 2, this.players[3].dim.x, this.players[3].dim.y);
