const translations: Record<string, Record<string, string>> = {
    ...
    losses: 'Losses',
    close: 'Close',
    invite_to_pong: 'Invite to Pong',
    you: 'You',
    accept: 'Accept',
    decline: 'Decline',
    new_chat: 'New chat',
    game_invite: 'Game invite',
    game_invite_sent: 'Game Invite Sent',
    you_sent_pong_invite: 'You sent a Pong invite to',
    invites_you_to_pong: 'invites you to a Pong match!',
    ...
    losses: 'Yenilgiler',
    close: 'Kapat',
    invite_to_pong: 'Pong\'a Davet Et',
    you: 'Siz',
    accept: 'Kabul Et',
    decline: 'Reddet',
    new_chat: 'Yeni sohbet',
    game_invite: 'Oyun daveti',
    game_invite_sent: 'Oyun Daveti Gönderildi',
    you_sent_pong_invite: 'Pong daveti gönderdin:',
    invites_you_to_pong: 'seni Pong maçına davet ediyor!',
