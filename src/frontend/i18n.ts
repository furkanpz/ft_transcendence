const translations: Record<string, Record<string, string>> = {
    ...
    user_blocked_you_warning: 'This user has blocked you. You cannot send messages.',
    user_blocked_by_you_warning: 'You have blocked this user.',
    more_options: 'More Options',
    please_select_user: 'Please select a user',
    room_preparing: 'Room is being prepared, please wait...',
    room_creation_failed: 'Room could not be created. Please try again.',
    websocket_disconnected: 'WebSocket connection lost. Page refreshing...',
    room_id_not_found: 'Room ID not found. Please select user again.',
    message_send_failed: 'Message could not be sent. Please try again.',
    user_not_found: 'User not found.',
    user_id_failed: 'Could not get user ID.',
    block_failed: 'Block failed',
    block_operation_failed: 'Block operation failed.',
    profile_load_failed: 'Profile could not be loaded.',
    friends_only_chat: 'Private chat is only possible with friends. Chat room will be created automatically when you become friends.',
    message_error: 'Message sending error.',
    unknown_error: 'Unknown error',
    error_prefix: 'Error',
    game_invite_sent_notification: 'Game invite sent to user!',
    game_invite_send_failed: 'Game invite could not be sent.',
    chat_connection_lost: 'Chat connection lost. Please refresh the page.',
    unable_to_connect_chat: 'Unable to connect to chat service. Please check your internet connection and try again.',
    failed_establish_connection: 'Failed to establish chat connection. Please refresh the page to reconnect.',
    chat_service_unavailable: 'Chat service is currently unavailable. Please try again later.',
    ...
    user_blocked_you_warning: 'Bu kullanıcı sizi bloklamış. Mesaj gönderemezsiniz.',
    user_blocked_by_you_warning: 'Bu kullanıcıyı engellediniz.',
    more_options: 'Daha Fazla Seçenek',
    please_select_user: 'Lütfen bir kullanıcı seçin',
    room_preparing: 'Oda hazırlanıyor, lütfen bekleyin...',
    room_creation_failed: 'Oda oluşturulamadı. Lütfen tekrar deneyin.',
    websocket_disconnected: 'WebSocket bağlantısı yok. Sayfa yenileniyor...',
    room_id_not_found: 'Oda ID bulunamadı. Lütfen kullanıcıyı tekrar seçin.',
    message_send_failed: 'Mesaj gönderilemedi. Lütfen tekrar deneyin.',
    user_not_found: 'Kullanıcı bulunamadı.',
    user_id_failed: 'Kullanıcı ID\'si alınamadı.',
    block_failed: 'Engelleme başarısız',
    block_operation_failed: 'Engelleme işlemi başarısız.',
    profile_load_failed: 'Profil yüklenemedi.',
    friends_only_chat: 'Sadece arkadaşlarla özel sohbet mümkündür. Arkadaş olunca sohbet odası otomatik oluşur.',
    message_error: 'Mesaj gönderme hatası.',
    unknown_error: 'Bilinmeyen hata',
    error_prefix: 'Hata',
    game_invite_sent_notification: 'kullanıcısına oyun daveti gönderildi!',
    game_invite_send_failed: 'Oyun daveti gönderilemedi.',
    chat_connection_lost: 'Chat bağlantısı yok. Lütfen sayfayı yenileyin.',
    unable_to_connect_chat: 'Chat servisine bağlanılamadı. Lütfen internet bağlantınızı kontrol edin ve tekrar deneyin.',
    failed_establish_connection: 'Chat bağlantısı kurulamadı. Lütfen sayfayı yenileyerek tekrar bağlanın.',
    chat_service_unavailable: 'Chat servisi şu anda kullanılamıyor. Lütfen daha sonra tekrar deneyin.',
    game_invite_declined: 'Oyun daveti reddedildi.',
    }
}
